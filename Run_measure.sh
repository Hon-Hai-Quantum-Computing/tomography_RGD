...
mea=2400
StateName=GHZ
meas_path=./DataTest/GHZ-3/GHZ-3_m10_s18/GHZ-3_m10_s18_shot2400_v2_Measure
...
taskset -c 1 python parallel_measurements.py $Nk $mea $StateName $meas_path ml_labels_0 > $Rec"0.txt" &
